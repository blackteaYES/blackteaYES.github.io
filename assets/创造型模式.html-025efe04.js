import{_ as p,V as c,W as o,X as n,Y as s,$ as t,a0 as e,C as i}from"./framework-a71e09ed.js";const l={},u=e(`<h1 id="创造型模式" tabindex="-1"><a class="header-anchor" href="#创造型模式" aria-hidden="true">#</a> 创造型模式</h1><p>  创造型模式是设计模式中的一类，它主要用于处理对象的创建，隐藏对象的创建细节，提供更加灵活的对象创建方式，降低系统的耦合度。</p><p>   常见的创造型模式包括：</p><ol style="padding-left:5em;"><li><a href="#简单工厂模式-simple-factory-pattern">简单工厂模式（Simple Factory Pattern）</a></li><li><a href="#工厂方法模式-factory-method-pattern">工厂方法模式（Factory Method Pattern）</a></li><li><a href="#抽象工厂模式-abstract-factory-pattern">抽象工厂模式（Abstract Factory Pattern）</a></li><li><a href="#单例模式-singleton-pattern">单例模式（Singleton Pattern）</a></li><li><a href="#原型模式-prototype-pattern">原型模式（Prototype Pattern）</a></li><li><a href="#建造者模式-builder-pattern">建造者模式（Builder Pattern）</a></li></ol><p>  其中，简单工厂模式、工厂方法模式和抽象工厂模式都是工厂模式的不同变体，它们都用于创建对象；</p><p>  单例模式用于保证一个类只有一个实例；</p><p>  原型模式用于复制对象；</p><p>  建造者模式用于创建复杂对象。</p><h2 id="简单工厂模式-simple-factory-pattern" tabindex="-1"><a class="header-anchor" href="#简单工厂模式-simple-factory-pattern" aria-hidden="true">#</a> 简单工厂模式（Simple Factory Pattern）</h2><p>  简单工厂模式是一种创建型设计模式，它通过一个工厂类来创建不同类型的对象。简单工厂模式将对象的创建过程封装在一个工厂类中，客户端只需要通过工厂类来获取所需的对象，而不需要知道具体的对象创建过程。</p><p>  在简单工厂模式中，工厂类负责创建不同类型的对象，并且可以根据客户端的需求来创建不同的对象。工厂类通常包含一个静态方法，该方法接收一个参数，根据参数的不同来创建不同类型的对象。</p><p>  简单工厂模式的优点是可以将对象的创建过程封装起来，客户端不需要知道具体的对象创建过程，从而减少了客户端的耦合度。同时，简单工厂模式也可以提高代码的复用性，因为可以在不同的客户端中重复使用同一个工厂类。</p><p>  简单工厂模式的缺点是当需要创建新类型的对象时，需要修改工厂类的代码，从而违反了开放-封闭原则。此外，简单工厂模式也会导致工厂类的代码变得过于复杂，难以维护。</p><h3 id="如何使用" tabindex="-1"><a class="header-anchor" href="#如何使用" aria-hidden="true">#</a> 如何使用</h3><p>在Spring Boot中使用简单工厂模式，可以通过以下步骤实现：</p><ol><li><p>定义一个动物接口Animal，并且实现接口：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
