...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​</p><h2 id="变量" tabindex="-1"><a class="header-anchor" href="#变量" aria-hidden="true">#</a> 变量</h2><h3 id="什么是变量" tabindex="-1"><a class="header-anchor" href="#什么是变量" aria-hidden="true">#</a> 什么是变量？</h3><p>变量：在程序运行时，能储存计算结果或能表示值的抽象概念。 简单的说，变量就是在程序运行时，记录数据用的。</p><figure><img src="https://i.niupic.com/images/2023/02/24/akW2.png" alt="变量的定义格式" tabindex="0" loading="lazy"><figcaption>变量的定义格式</figcaption></figure><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>
    <span class="token triple-quoted-string string">&quot;&quot;&quot;
    当前余额为50元,
    买一支冰淇淋花费5元,
    再买一瓶可乐花费3.5元，
...
</code></pre><figure><img src="https://i.niupic.com/images/2023/02/24/akWd.png" alt="变量有类型嘛？" tabindex="0" loading="lazy"><figcaption>变量有类型嘛？</figcaption></figure><blockquote><p>数据类型代码：</p></blockquote><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>    <span class="token keyword">from</span> re <span class="token keyword">import</span> A
​    
...
祝您游玩愉快
PS D:<span class="token punctuation">\\</span>code<span class="token punctuation">\\</span>py<span class="token punctuation">\\</span>heima_py<span class="token operator">&gt;</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="判断语句的嵌套" tabindex="-1"><a class="header-anchor" href="#判断语句的嵌套" aria-hidden="true">#</a> 判断语句的嵌套</h3><figure><img src="https://i.niupic.com/images/2023/02/24/akWi.png" alt="嵌套判断图" tabindex="0" loading="lazy"><figcaption>嵌套判断图</figcaption></figure><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># 判断语句嵌套代码：</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="循环语句" tabindex="-1"><a class="header-anchor" href="#循环语句" aria-hidden="true">#</a> 循环语句</h2><figure><img src="https://i.niupic.com/images/2023/02/24/akWj.png" alt="循环语句前言" tabindex="0" loading="lazy"><figcaption>循环语句前言</figcaption></figure><h3 id="while循环的基础语法" tabindex="-1"><a class="header-anchor" href="#while循环的基础语法" aria-hidden="true">#</a> while循环的基础语法</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>程序中的循环：
...
name <span class="token operator">=</span> <span class="token boolean">None</span>
    ...
    函数体
    <span class="token keyword">return</span> 返回值
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过多行注释的形式，对函数进行说明解释</p><ul><li>内容应写在函数体之前</li></ul><p>vs code将鼠标悬停在add()调用方法上，可以看到注释内容。</p><figure><img src="https://i.niupic.com/images/2023/02/24/akY7.png" alt="vscode显示注释内容" tabindex="0" loading="lazy"><figcaption>vscode显示注释内容</figcaption></figure><ul><li>：param用来解释参数</li><li>：return用来解释返回值</li></ul><h3 id="函数的嵌套使用" tabindex="-1"><a class="header-anchor" href="#函数的嵌套使用" aria-hidden="true">#</a> 函数的嵌套使用</h3><p>什么是函数的嵌套？</p><p>所谓函数嵌套调用指的是一个函数里面又调用了另外一个函数。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">func_b</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="集合的操作" tabindex="-1"><a class="header-anchor" href="#集合的操作" aria-hidden="true">#</a> 集合的操作</h4><figure><img src="https://i.niupic.com/images/2023/02/24/akYb.png" alt="集合的操作" tabindex="0" loading="lazy"><figcaption>集合的操作</figcaption></figure><p>​</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
02_set(集合)的操作.py
&quot;&quot;&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>​ 注意：此时的 <code>f</code> 是 <code>open</code> 函数的文件对象，对象是Python中一种特殊的数据类型，拥有属性和方法，可以使用对象.属性或对象.方法对其进行访问。</p>`,9),q={href:"https://m.runoob.com/python/file-methods.html",target:"_blank",rel:"noopener noreferrer"},w=a(`<div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
01_文件的操作.py
&quot;&quot;&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><p>注意：</p><ul><li>from可以省略，直接import即可</li><li>as别名可以省略</li><li>通过“.”来确定层级关系</li><li>描块的导入一般写在代码文件的开头位置</li></ul><h3 id="模块自定义模块" tabindex="-1"><a class="header-anchor" href="#模块自定义模块" aria-hidden="true">#</a> 模块自定义模块</h3><figure><img src="https://i.niupic.com/images/2023/02/24/akYf.png" alt="自定义模块用例图片" tabindex="0" loading="lazy"><figcaption>自定义模块用例图片</figcaption></figure><blockquote><p>自定义的模块代码(单独的文件):</p></blockquote><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
自定义模块
&quot;&quot;&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="python包" tabindex="-1"><a class="header-anchor" href="#python包" aria-hidden="true">#</a> python包</h2><h3 id="自定义包" tabindex="-1"><a class="header-anchor" href="#自定义包" aria-hidden="true">#</a> 自定义包</h3><p>​ 从物理上看，包就是一个文件夹，在该文件夹下包含了一个iit·py文件，该文件夹可</p><p>​ 用于包含多个模块文件从逻辑上看，包的本质依然是模块。</p><p>​ <img src="https://i.niupic.com/images/2023/02/24/akYg.png" alt="python包图" loading="lazy"></p><p>​ 实际层级关系如下：</p><p>​ <img src="https://i.niupic.com/images/2023/02/24/akYD.png" alt="python自定义包的层级关系" loading="lazy"></p><p>步骤如下：</p>`,68),x={href:"http://init.py",target:"_blank",rel:"noopener noreferrer"},P=a(`<li><p>写包里待导出的函数代码</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
my_module1.py
&quot;&quot;&quot;</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span><span class="token builtin">type</span><span class="token punctuation">(</span>data<span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="pyecharts" tabindex="-1"><a class="header-anchor" href="#pyecharts" aria-hidden="true">#</a> pyecharts</h2>`,4),T={href:"https://pyecharts.org",target:"_blank",rel:"noopener noreferrer"},O=a(`<p>​ 如果想要做出数据可视化效果图，可以借助pyecharts模块来完成。</p><p>​ 概况：</p><p>​ Echarts是个由百度开源的数据可视化，凭借着良好的交互性，精巧的图表 设计，得到了众多开发者的认可.而Python是门富有表达力的语言，很适合用 于数据处理，当数据分析遇上数据可视化时pyecharts诞生了。</p><p>安装pyecharts:</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>pip install pyecharts
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​</p><ul><li>暂无</li></ul><h3 id="pyecharts有哪些配置选项" tabindex="-1"><a class="header-anchor" href="#pyecharts有哪些配置选项" aria-hidden="true">#</a> pyecharts有哪些配置选项</h3><p>pyecharts模块中有很多的配置选项，常用到2个类别的选项：</p><h4 id="全局配置选项" tabindex="-1"><a class="header-anchor" href="#全局配置选项" aria-hidden="true">#</a> 全局配置选项</h4>`,13),E={href:"https://pyecharts.org/#/zh-cn/global_options",target:"_blank",rel:"noopener noreferrer"},C=a(`<p>​ set_global_opts 方法</p><p>​ 这里全局配置选项可以通过set_global_opts方法来进行配置，相应的选项和选项的功能如下：</p><figure><img src="https://i.niupic.com/images/2023/02/24/akYi.png" alt="set_global_opts方法实现案例图片" tabindex="0" loading="lazy"><figcaption>set_global_opts方法实现案例图片</figcaption></figure><p>​</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
01_基础折线图.py
&quot;&quot;&quot;</span>
...
student<span class="token punctuation">.</span>say_hi<span class="token punctuation">(</span><span class="token punctuation">)</span>
    ...
    方法体
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到，在方法定义的参数列表中，有一个：self关键字</p><p>self关键字是成员方法定义的时候，必须填写的。</p><ul><li>它用来表示类对象自身的意思 。</li><li>当我们使用类对象调用方法的是，self会自动被python传入 。</li><li>在方法内部，想要访问类的成员变量，必须使用self 。</li></ul><h3 id="类和对象" tabindex="-1"><a class="header-anchor" href="#类和对象" aria-hidden="true">#</a> 类和对象</h3><h4 id="现实世界的事物和类" tabindex="-1"><a class="header-anchor" href="#现实世界的事物和类" aria-hidden="true">#</a> 现实世界的事物和类</h4><figure><img src="https://i.niupic.com/images/2023/02/24/akYj.png" alt="现实世界的事物和类图" tabindex="0" loading="lazy"><figcaption>现实世界的事物和类图</figcaption></figure><h4 id="为什么非要创建对象才能使用呢" tabindex="-1"><a class="header-anchor" href="#为什么非要创建对象才能使用呢" aria-hidden="true">#</a> 为什么非要创建对象才能使用呢？</h4><p>​ 类只是一种程序内的“设计图纸”，需要基于图纸生产实体（对象），才能正常工作</p><p>​ 这种套路，称之为：面向对象编程。</p><h4 id="在程序中通过类来描述面向对象" tabindex="-1"><a class="header-anchor" href="#在程序中通过类来描述面向对象" aria-hidden="true">#</a> 在程序中通过类来描述面向对象</h4><figure><img src="https://i.niupic.com/images/2023/02/24/akYk.png" alt="通过程序来描述闹钟对象图" tabindex="0" loading="lazy"><figcaption>通过程序来描述闹钟对象图</figcaption></figure><h4 id="基于类创建对象" tabindex="-1"><a class="header-anchor" href="#基于类创建对象" aria-hidden="true">#</a> 基于类创建对象</h4><figure><img src="https://i.niupic.com/images/2023/02/24/akYl.png" alt="基于闹钟类创建对象图" tabindex="0" loading="lazy"><figcaption>基于闹钟类创建对象图</figcaption></figure><h4 id="代码实现" tabindex="-1"><a class="header-anchor" href="#代码实现" aria-hidden="true">#</a> 代码实现</h4><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="其他内置方法" tabindex="-1"><a class="header-anchor" href="#其他内置方法" aria-hidden="true">#</a> 其他内置方法</h3><p>上文学习的init构造方法，是Python:类内置的方法之一。</p><h4 id="其他常用得内置方法" tabindex="-1"><a class="header-anchor" href="#其他常用得内置方法" aria-hidden="true">#</a> 其他常用得内置方法</h4><figure><img src="https://i.niupic.com/images/2023/02/24/akYm.png" alt="其他常用得内置方法图" tabindex="0" loading="lazy"><figcaption>其他常用得内置方法图</figcaption></figure><p>​ 这些内置的类方法，各自有各自特殊的功能，这些内置方法我们称之为： <strong>魔术方法</strong> 。</p><figure><img src="https://i.niupic.com/images/2023/02/24/akYn.png" alt="常见魔术方法图" tabindex="0" loading="lazy"><figcaption>常见魔术方法图</figcaption></figure><h4 id="str-字符串方法" tabindex="-1"><a class="header-anchor" href="#str-字符串方法" aria-hidden="true">#</a> __str__字符串方法</h4><figure><img src="https://i.niupic.com/images/2023/02/24/akYo.png" alt="不使用__str__方法图" tabindex="0" loading="lazy"><figcaption>不使用__str__方法图</figcaption></figure><figure><img src="https://i.niupic.com/images/2023/02/24/akYp.png" alt="使用__str__方法图" tabindex="0" loading="lazy"><figcaption>使用__str__方法图</figcaption></figure><blockquote><p>代码：</p></blockquote><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
04_常用魔术方法.py
&quot;&quot;&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="lt-小于符号比较" tabindex="-1"><a class="header-anchor" href="#lt-小于符号比较" aria-hidden="true">#</a> __lt__小于符号比较</h4><figure><img src="https://i.niupic.com/images/2023/02/24/akYq.png" alt="未使用lt小于符号比较图" tabindex="0" loading="lazy"><figcaption>未使用lt小于符号比较图</figcaption></figure><figure><img src="https://i.niupic.com/images/2023/02/24/akYr.png" alt="使用lt小于符号比较图" tabindex="0" loading="lazy"><figcaption>使用lt小于符号比较图</figcaption></figure><blockquote><p>代码：</p></blockquote><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
04_常用魔术方法.py
&quot;&quot;&quot;</span>
<span class="token keyword">class</span> <span class="token class-name">Stu1</span><span class="token punctuation">:</span>
    <span class="token keyword">def</span> <span class="token function">__init__</span><span class="token punctuation">(</span>self<span class="token punctuation">,</span> name<span class="token punctuation">,</span> age<span class="token punctuation">)</span> <span class="token operator">-</span><span class="token operator">&gt;</span> <span class="token boolean">None</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="le-小于等于比较" tabindex="-1"><a class="header-anchor" href="#le-小于等于比较" aria-hidden="true">#</a> __le__小于等于比较</h4><figure><img src="https://i.niupic.com/images/2023/02/24/akYs.png" alt="lt小于等于方法比较图" tabindex="0" loading="lazy"><figcaption>lt小于等于方法比较图</figcaption></figure><blockquote><p>代码：</p></blockquote><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
04_常用魔术方法.py
&quot;&quot;&quot;</span>
<span class="token keyword">class</span> <span class="token class-name">Stu1</span><span class="token punctuation">:</span>
    <span class="token keyword">def</span> <span class="token function">__init__</span><span class="token punctuation">(</span>self<span class="token punctuation">,</span> name<span class="token punctuation">,</span> age<span class="token punctuation">)</span> <span class="token operator">-</span><span class="token operator">&gt;</span> <span class="token boolean">None</span><span class="token punctuation">:</span>
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&#39;__main__&#39;</span><span class="token punctuation">:</span>
    ...
    <span class="token comment"># AttributeError: &#39;Phone&#39; object has no attribute &#39;__keep_single_core&#39;</span>
    <span class="token comment"># phone.__keep_single_core()</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​</p><h4 id="继承" tabindex="-1"><a class="header-anchor" href="#继承" aria-hidden="true">#</a> 继承</h4><p>继承分为：单继承和多继承。</p><h5 id="单继承" tabindex="-1"><a class="header-anchor" href="#单继承" aria-hidden="true">#</a> 单继承</h5><figure><img src="https://i.niupic.com/images/2023/02/24/akYu.png" alt="单继承实现图" tabindex="0" loading="lazy"><figcaption>单继承实现图</figcaption></figure><p>语法：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">class</span> 类名<span class="token punctuation">(</span>父类名<span class="token punctuation">)</span><span class="token punctuation">:</span>
    类内容体
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​</p><h5 id="多继承" tabindex="-1"><a class="header-anchor" href="#多继承" aria-hidden="true">#</a> 多继承</h5><figure><img src="https://i.niupic.com/images/2023/02/24/akYv.png" alt="多继承图" tabindex="0" loading="lazy"><figcaption>多继承图</figcaption></figure><p>​</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token string">&quot;&quot;</span>&quot;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​</p><h5 id="复写和使用" tabindex="-1"><a class="header-anchor" href="#复写和使用" aria-hidden="true">#</a> 复写和使用</h5><p>​ 子类继承父类的成员属性和成员方法后，如果对其“不满意”，那么可以进行复写。</p><p>​ 即：在子类中重新定义同名的属性或方法即可。</p><figure><img src="https://i.niupic.com/images/2023/02/24/akYw.png" alt="复写示例图" tabindex="0" loading="lazy"><figcaption>复写示例图</figcaption></figure><h5 id="调用父类同名成员" tabindex="-1"><a class="header-anchor" href="#调用父类同名成员" aria-hidden="true">#</a> 调用父类同名成员</h5><p>一旦复写父类成员，那么类对象调用成员的时候，就会调用复写后的新成员</p><p>如果需要使用被复写的父类的成员，需要特殊的调用方式：</p><ul><li>调用父类成员 使用成员变量：父类名.成员变量 使用成员方法：父类名.成员方法(self)</li><li>使用super()调用父类成员 使用成员变量：super().成员变量 使用成员方法：super().成员方法()</li></ul><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
08_调用父类同名成员.py
&quot;&quot;&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​</p><figure><img src="https://i.niupic.com/images/2023/02/24/akYy.png" alt="形参效果图" tabindex="0" loading="lazy"><figcaption>形参效果图</figcaption></figure><p><strong>返回值注解</strong></p><p>除了上面的那种 注释中进行类型注解 以外还可以用如下方式：</p><pre><code>def add(a: int, b:int) -&gt; int:
    return a+b    

if __name__ == &#39;__main__&#39;:
    print(add(2, 3))
</code></pre><figure><img src="https://i.niupic.com/images/2023/02/24/akYz.png" alt="返回值注解2图" tabindex="0" loading="lazy"><figcaption>返回值注解2图</figcaption></figure><h6 id="union联合注解" tabindex="-1"><a class="header-anchor" href="#union联合注解" aria-hidden="true">#</a> Union联合注解</h6><p><strong>变量使用Union</strong></p><figure><img src="https://i.niupic.com/images/2023/02/24/akYA.png" alt="需要使用Union的场景图" tabindex="0" loading="lazy"><figcaption>需要使用Union的场景图</figcaption></figure><figure><img src="https://i.niupic.com/images/2023/02/24/akYB.png" alt="使用Union后的场景图" tabindex="0" loading="lazy"><figcaption>使用Union后的场景图</figcaption></figure><p><strong>函数使用Union</strong></p><figure><img src="https://i.niupic.com/images/2023/02/24/akYF.png" alt="函数使用Union" tabindex="0" loading="lazy"><figcaption>函数使用Union</figcaption></figure><figure><img src="https://i.niupic.com/images/2023/02/24/akYG.png" alt="函数使用Union效果图" tabindex="0" loading="lazy"><figcaption>函数使用Union效果图</figcaption></figure><h6 id="类型注解相关代码" tabindex="-1"><a class="header-anchor" href="#类型注解相关代码" aria-hidden="true">#</a> 类型注解相关代码</h6><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
09_类型注解.py
&quot;&quot;&quot;</span>
<span class="token keyword">import</span> json
...
<span class="token comment"># 关闭到数据库的连接</span>
conn<span class="token punctuation">.</span>close<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="pyspark" tabindex="-1"><a class="header-anchor" href="#pyspark" aria-hidden="true">#</a> PySpark</h2><p>​ 暂时省略</p><h1 id="python进阶" tabindex="-1"><a class="header-anchor" href="#python进阶" aria-hidden="true">#</a> python进阶</h1><h2 id="闭包" tabindex="-1"><a class="header-anchor" href="#闭包" aria-hidden="true">#</a> 闭包</h2><blockquote><p>非闭包的错误使用方式图</p></blockquote><figure><img src="https://i.niupic.com/images/2023/02/24/akYH.png" alt="非闭包的错误使用方式图" tabindex="0" loading="lazy"><figcaption>非闭包的错误使用方式图</figcaption></figure><blockquote><p>转换闭包形式的代码图</p></blockquote><figure><img src="https://i.niupic.com/images/2023/02/24/akYI.png" alt="转换闭包形式的代码图" tabindex="0" loading="lazy"><figcaption>转换闭包形式的代码图</figcaption></figure><p>​</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
03_闭包实现ATM小案例.py
&quot;&quot;&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​</p><h3 id="工厂模式" tabindex="-1"><a class="header-anchor" href="#工厂模式" aria-hidden="true">#</a> 工厂模式</h3><p>当需要大量创建一个类的实例的时候，可以使用工厂模式。</p><p>即，从原生的使用类的构造去创建对象的形式</p><p>迁移到，基于工厂提供的方法去创建对象的形式。</p><blockquote><p>转变为工厂模式</p></blockquote><figure><img src="https://i.niupic.com/images/2023/02/24/akYL.png" alt="转变为工厂模式图" tabindex="0" loading="lazy"><figcaption>转变为工厂模式图</figcaption></figure><blockquote><p>举例代码：</p></blockquote><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
01_工厂模式.py
&quot;&quot;&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用工厂类的get_person(0方法去创建具体的类对象。</p><p>优点：</p><ul><li>大批量创建对象的时候有统一的入口，易于代码维护。</li><li>当发生修改，仅修改工厂类的创建方法即可。</li><li>符合现实世界的模式，即由工厂来制作产品（对象）。</li></ul><h2 id="多线程" tabindex="-1"><a class="header-anchor" href="#多线程" aria-hidden="true">#</a> 多线程</h2><h3 id="进程、线程" tabindex="-1"><a class="header-anchor" href="#进程、线程" aria-hidden="true">#</a> 进程、线程</h3><p>​ 现代操作系统比如Mac OS X,UNIX,Linux,Windows等，都是支持“多任务”的操作系统。</p><p>​ 进程：就是一个程序，运行在系统之上，那么便称之这个程序为一个运行进程，并分配进程ID方便系统管理。</p><p>​ 线程：线程是归属于进程的，一个进程可以开启多个线程，执行不同的工作，是进程的实际工作最小单位。</p><p>​ <img src="https://i.niupic.com/images/2023/02/24/akYM.png" alt="任务管理器图" loading="lazy"></p><p>​ 进程就好比一家公司，是操作系统对程序进行运行管理的单位。</p><p>​ 线程就好比公司的员工，进程可以有多个线程（员工)，是进程实际的工作者。</p><p>​ 操作系统中可以运行多个进程，即多任务运行。</p><p>​ 一个进程内可以运行多个线程，即多线程运行。</p><blockquote><p>进程、线程注意点</p></blockquote><figure><img src="https://i.niupic.com/images/2023/02/24/akYN.png" alt="进程、线程注意点图" tabindex="0" loading="lazy"><figcaption>进程、线程注意点图</figcaption></figure><h4 id="并行执行" tabindex="-1"><a class="header-anchor" href="#并行执行" aria-hidden="true">#</a> 并行执行</h4><p>并行执行的意思指的是同一时间做不同的工作。</p><p>进程之间就是并行执行的，操作系统可以同时运行好多程序，这些程序都是在并行执行。</p><p>除了进程外，线程其实也是可以并行执行的。</p><p>也就是比如一个Python程序，其实是完全可以做到：</p><ul><li>一个线程在输出：你好</li><li>一个线程在输出：Hello</li></ul><p>像这样一个程序在同一时间做两件乃至多件不同的事情，我们就称之为：多线程并行执行。</p><h3 id="多线程编程" tabindex="-1"><a class="header-anchor" href="#多线程编程" aria-hidden="true">#</a> 多线程编程</h3><h4 id="threading模块" tabindex="-1"><a class="header-anchor" href="#threading模块" aria-hidden="true">#</a> threading模块</h4><p>绝大多数编程语言，都允许多线程编程，Pyhton也不例外。</p><p>Python的多线程可以通过threading模块来实现。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
01_多线程.py
&quot;&quot;&quot;</span>
